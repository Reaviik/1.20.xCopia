...
public class ModBlocksAdditions {
    ...
    public static final RegistryObject<Block> VOXEL_BLOCK = registerBlock("voxel_cube", () -> new Voxel(BlockBehaviour.Properties.copy(Blocks.NETHERITE_BLOCK).requiresCorrectToolForDrops().strength(3.0f, 6.0f).sound(SoundType.FROGLIGHT).mapColor(MapColor.ICE)));
    public static final RegistryObject<Block> ENTITY_CENTRALIZER = registerBlock("entity_centralizer", () -> new EntityCentralizer(BlockBehaviour.Properties.copy(Blocks.WHITE_CARPET).requiresCorrectToolForDrops().strength(1.0f, 1.0f).sound(SoundType.FROGLIGHT).noCollission().mapColor(MapColor.METAL)));
    ...
    public static final RegistryObject<Block> SOLAR = registerBlock("solar", () -> new Solar(BlockBehaviour.Properties.copy(Blocks.GLASS).requiresCorrectToolForDrops().strength(1.0f, 6.0f).lightLevel((state) -> state.getValue(Solar.LIT) > 0 ? 2 : 0).noOcclusion().mapColor(MapColor.METAL)));
    public static final RegistryObject<Block> FERMENTATION_BARREL = registerBlock("fermentation_barrel", () -> new FermentationBarrel(BlockBehaviour.Properties.copy(Blocks.GLASS).requiresCorrectToolForDrops().sound(SoundType.WOOD).strength(1.0f, 6.0f).noOcclusion().mapColor(MapColor.WOOD)));
    ...
    public static final RegistryObject<Block> PURPLE_LIGHT_CRYSTAL = registerBlock("purple_light_crystal", () -> new LightCrystal(BlockBehaviour.Properties.copy(Blocks.GLASS).requiresCorrectToolForDrops().strength(2.0f, 6.0f).sound(SoundType.GLASS).lightLevel((state) -> 15).noOcclusion().mapColor(MapColor.COLOR_PURPLE), BlockSetType.POLISHED_BLACKSTONE, 1, true));
    public static final RegistryObject<Block> YELLOW_LIGHT_CRYSTAL = registerBlock("yellow_light_crystal", () -> new LightCrystal(BlockBehaviour.Properties.copy(Blocks.GLASS).requiresCorrectToolForDrops().strength(2.0f, 6.0f).sound(SoundType.GLASS).lightLevel((state) -> 15).noOcclusion().mapColor(MapColor.COLOR_YELLOW), BlockSetType.POLISHED_BLACKSTONE, 1, true));
    public static final RegistryObject<Block> WHITE_LIGHT_CRYSTAL = registerBlock("white_light_crystal", () -> new LightCrystal(BlockBehaviour.Properties.copy(Blocks.GLASS).requiresCorrectToolForDrops().strength(2.0f, 6.0f).sound(SoundType.GLASS).lightLevel((state) -> 15).noOcclusion().mapColor(MapColor.TERRACOTTA_WHITE), BlockSetType.POLISHED_BLACKSTONE, 1, true));
    public static final RegistryObject<Block> RED_LIGHT_CRYSTAL = registerBlock("red_light_crystal", () -> new LightCrystal(BlockBehaviour.Properties.copy(Blocks.GLASS).requiresCorrectToolForDrops().strength(2.0f, 6.0f).sound(SoundType.GLASS).lightLevel((state) -> 15).noOcclusion().mapColor(MapColor.COLOR_RED), BlockSetType.POLISHED_BLACKSTONE, 1, true));
    public static final RegistryObject<Block> ORANGE_LIGHT_CRYSTAL = registerBlock("orange_light_crystal", () -> new LightCrystal(BlockBehaviour.Properties.copy(Blocks.GLASS).requiresCorrectToolForDrops().strength(2.0f, 6.0f).sound(SoundType.GLASS).lightLevel((state) -> 15).noOcclusion().mapColor(MapColor.COLOR_ORANGE), BlockSetType.POLISHED_BLACKSTONE, 1, true));
    public static final RegistryObject<Block> PINK_LIGHT_CRYSTAL = registerBlock("pink_light_crystal", () -> new LightCrystal(BlockBehaviour.Properties.copy(Blocks.GLASS).requiresCorrectToolForDrops().strength(2.0f, 6.0f).sound(SoundType.GLASS).lightLevel((state) -> 15).noOcclusion().mapColor(MapColor.COLOR_PINK), BlockSetType.POLISHED_BLACKSTONE, 1, true));
    public static final RegistryObject<Block> GREEN_LIGHT_CRYSTAL = registerBlock("green_light_crystal", () -> new LightCrystal(BlockBehaviour.Properties.copy(Blocks.GLASS).requiresCorrectToolForDrops().strength(2.0f, 6.0f).sound(SoundType.GLASS).lightLevel((state) -> 15).noOcclusion().mapColor(MapColor.COLOR_GREEN), BlockSetType.POLISHED_BLACKSTONE, 1, true));
    public static final RegistryObject<Block> BLUE_LIGHT_CRYSTAL = registerBlock("blue_light_crystal", () -> new LightCrystal(BlockBehaviour.Properties.copy(Blocks.GLASS).requiresCorrectToolForDrops().strength(2.0f, 6.0f).sound(SoundType.GLASS).lightLevel((state) -> 15).noOcclusion().mapColor(MapColor.COLOR_BLUE), BlockSetType.POLISHED_BLACKSTONE, 1, true));
